...
const item = {
  ...
  show: { opacity: 1, y: 0, transition: { duration: 0.7, ease: [0.215, 0.61, 0.355, 1] as const } }
};
...
export default function ServicesPage() {
  ...
  return (
    <>
      ...
      {/* CTA SECTION */}
      <section className="py-20 lg:py-28 bg-linear-to-br from-primary/5 to-secondary/5">
